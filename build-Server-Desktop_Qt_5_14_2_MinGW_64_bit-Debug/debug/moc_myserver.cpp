...
QT_MOC_LITERAL(1, 9, 12), // "data_to_send"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 18), // "incomingConnection"
QT_MOC_LITERAL(4, 42, 7), // "qintptr"
QT_MOC_LITERAL(5, 50, 16), // "socketDescreptor"
QT_MOC_LITERAL(6, 67, 13) // "slotReadyRead"

    },
    "myServer\0data_to_send\0\0incomingConnection\0"
    "qintptr\0socketDescreptor\0slotReadyRead"
};
...
void myServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->data_to_send((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&myServer::data_to_send)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void myServer::data_to_send(QByteArray _t1)
{
